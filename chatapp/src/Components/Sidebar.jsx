...
function Sidebar() {
  ...
  return (
    <>
      <div
        id="sidebar-mini"
        class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-32 border-e border-gray-200 lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 bg-white"
      >
        <div class="flex flex-col justify-center items-center gap-y-2 py-4">
          ...
          <div class="hs-tooltip inline-block [--placement:right]">
            ...
            >
              ...
              <span
                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute  z-20 py-1.5 px-2.5 bg-gray-900 text-xs text-red rounded-lg whitespace-nowrap dark:bg-neutral-700"
                role="tooltip"
              >
                Home
              </span>
